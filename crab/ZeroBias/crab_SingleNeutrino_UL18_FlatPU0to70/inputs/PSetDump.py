...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/d0/scratch/sha/Analyses/ServiceWork/JERC/MiniAOD/SingleNeutrino_UL18FlatPU0to70/006AF999-107E-554D-8EEB-064BE2F2F05C.root')
)
...
process.pf = cms.EDAnalyzer("OffsetTreeMaker",
    ...
    RootFileName = cms.string('Offset_MC.root'),
