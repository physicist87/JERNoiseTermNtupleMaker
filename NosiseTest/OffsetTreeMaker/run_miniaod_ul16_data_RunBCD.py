...
readFiles.extend( [
  ...
  'file:../../../../../DataFile/0C44A7FD-D327-6F4D-850F-9D0B6D3F0680.root' 
] );
...
if isMC:
  ...
  process.GlobalTag = GlobalTag( process.GlobalTag, '106X_mcRun2_asymptotic_v15' )# for MC (post-VFP)
  ...
  process.GlobalTag = GlobalTag( process.GlobalTag, '106X_dataRun2_v37' ) #UL2016 B-H
  ...
  run = "BCD"
  eraName = "Summer19UL16APV_Run"+run+"_V7_DATA" #Summer19UL16APV_RunBCD_V7_DATA
  jetType_name = "AK4PFchs" # or "AK4PF" 
