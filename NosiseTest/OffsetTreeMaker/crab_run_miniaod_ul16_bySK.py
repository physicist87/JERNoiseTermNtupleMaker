...
config.JobType.psetName = 'run_miniaod_ul16_mc.py'
...
#config.Data.splitting = 'EventAwareLumiBased'
#config.Data.unitsPerJob = 1
#config.Data.unitsPerJob = 1 #number of file per job (Filebased) 
...
if __name__ == '__main__':
    ...
    config.General.requestName = 'SingleNeutrino_UL16_Epsilon_v14'
    config.Data.inputDataset = '/SingleNeutrino/RunIISummer20UL16MiniAODv2-EpsilonPU_106X_mcRun2_asymptotic_v17-v2/MINIAODSIM'
    crabCommand('submit', config = config)
