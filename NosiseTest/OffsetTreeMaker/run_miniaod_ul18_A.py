...
readFiles.extend( [
  ...
  'file:/d0/scratch/sha/Analyses/ServiceWork/JERC/MiniAOD/DataRun2018/032F9DB5-A22C-5246-A1B3-E0EB0C539A8E.root'
...
if isMC:
  ...
  run = "A"
  eraName = "Summer19UL18_Run"+run+"_V5_DATA"
  jetType_name = "AK4PFchs" # or "AK4PF"
...
#    puFileName = cms.string("pileup_2017.txt"),
    ...
    trigList        = cms.vstring(
                                                        ...
                                                        'HLT_ZeroBias_part',
                                                       'HLT_ZeroBias_v',
                                                       'HLT_L1MinimumBiasHF_OR_v',
                                                       'HLT_L1MinimumBiasHF0OR_v'
                                                        ),
