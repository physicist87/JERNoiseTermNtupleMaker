...
config.JobType.psetName = 'run_miniaod_ul16_data_RunFGH.py'
...
if __name__ == '__main__':
    ...
    config.General.requestName = 'SingleCone_Run2016Fl_v1'
    config.Data.inputDataset = '/ZeroBias/Run2016F-UL2016_MiniAODv2-v1/MINIAOD'
    crabCommand('submit', config = config)

    config.General.requestName = 'SingleCone_Run2016G_v1'
    config.Data.inputDataset = '/ZeroBias/Run2016G-UL2016_MiniAODv2-v1/MINIAOD'
    crabCommand('submit', config = config)

    config.General.requestName = 'SingleCone_Run2016H_v1'
