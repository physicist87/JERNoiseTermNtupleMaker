...
config.JobType.psetName = 'run_miniaod_ul16_mc_postvfp.py'
...
if __name__ == '__main__':
    ...
    #config.General.requestName = 'SingleNeutrino_UL16_PostVFP_MiniADOv2_v9'
    config.General.requestName = 'SingleCone_UL16_FlatPU0to75_PostVFP_v2p3'
