...
if isMC:
  ...
  process.GlobalTag = GlobalTag( process.GlobalTag, '106X_mcRun2_asymptotic_preVFP_v11' )# for MC (pre-VFP)
  #process.GlobalTag = GlobalTag( process.GlobalTag, '106X_mcRun2_asymptotic_v15' )# for MC (post-VFP)
  #eraName = "Summer19UL18_V5_MC"
  eraName = "Summer19UL16APV_V7_MC"
  ...
  process.GlobalTag = GlobalTag( process.GlobalTag, '106X_dataRun2_v32' ) #UL2016
