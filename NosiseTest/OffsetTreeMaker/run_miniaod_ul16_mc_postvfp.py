...
readFiles.extend( [
  ...
  'file:/d0/scratch/sha/Analyses/ServiceWork/JERC/NoiseTerm_v1/MakeNtuple_v1/ForSummer20_v1/For16Sample_APV/023791C7-33F3-BD43-AD98-F288389A9575.root' 
] );
...
if isMC:
  ...
  process.GlobalTag = GlobalTag( process.GlobalTag, '106X_mcRun2_asymptotic_v17' )# for MC (post-VFP)
  #eraName = "Summer19UL18_V5_MC"
  eraName = "Summer19UL16_V7_MC" # Post VPF (NonAPV)
