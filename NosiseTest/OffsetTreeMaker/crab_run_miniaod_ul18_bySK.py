...
config.Data.outLFNDirBase = '/store/user/sha/JERNosieStudy/SingleNeutrino'
...
if __name__ == '__main__':
    ...
    config.General.requestName = 'SingleConeTest_FlatPU0to75_v2p3'
    config.Data.inputDataset = '/SingleNeutrino/RunIISummer20UL18MiniAODv2-FlatPU0to75_106X_upgrade2018_realistic_v16_L1v1-v2/MINIAODSIM'
    crabCommand('submit', config = config)
 
    config.General.requestName = 'SingleConeTest_PreMix_v2p3'
    config.Data.inputDataset = '/SingleNeutrino/RunIISummer20UL18MiniAODv2-106X_upgrade2018_realistic_v16_L1v1-v2/MINIAODSIM'
    crabCommand('submit', config = config)
 
    #config.General.requestName = 'SingleConeTest_PreMix_TRKv1_v1p4'
    #config.Data.inputDataset = '/SingleNeutrino/RunIISummer20UL18MiniAODv2-PUForTRK_TRK_106X_upgrade2018_realistic_v16_L1v1-v2/MINIAODSIM'
    #crabCommand('submit', config = config)

    #config.General.requestName = 'SingleConeTest_PreMix_TRKv2_v1p4'
    #config.Data.inputDataset = '/SingleNeutrino/RunIISummer20UL18MiniAODv2-PUForTRKv2_TRKv2_106X_upgrade2018_realistic_v16_L1v1-v2/MINIAODSIM'
    #crabCommand('submit', config = config)
    ...
    #config.General.requestName = 'SingleNeutrino_UL18_NoPU_v9'
    #config.Data.inputDataset = '/SingleNeutrino/RunIISummer19UL18MiniAODv2-NZSNoPU_106X_upgrade2018_realistic_v16_L1v1-v1/MINIAODSIM'
    #crabCommand('submit', config = config)

    #config.General.requestName = 'SingleNeutrino_UL18_NoPU_HEM_v9'
    #config.Data.inputDataset = '/SingleNeutrino/RunIISummer19UL18MiniAODv2-NZSNoPU_UL18HEMreReco_106X_upgrade2018_realistic_v16_L1v1-v1/MINIAODSIM'
    #crabCommand('submit', config = config)
