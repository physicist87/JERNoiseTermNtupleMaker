...
if __name__ == '__main__':
    ...
    config.General.requestName = 'SingleNeutrino_UL16_NoPU_v1'
    config.Data.inputDataset = '/SingleNeutrino/RunIISummer20UL16MiniAODv2-NoPU_106X_mcRun2_asymptotic_v17-v2/MINIAODSIM'
    crabCommand('submit', config = config)
