...
if __name__ == '__main__':
    ...
    #config.General.requestName = 'SingleNeutrino_UL18_FlatPU0to75-ext1-v1'
    #config.Data.inputDataset = '/SingleNeutrino/RunIISummer19UL18MiniAODv2-FlatPU0to75_106X_upgrade2018_realistic_v16_L1v1_ext1-v1/MINIAODSIM'
    #crabCommand('submit', config = config)

    #config.General.requestName = 'SingleNeutrino_UL18_FlatPU0to75-ext2-v1'
    #config.Data.inputDataset = '/SingleNeutrino/RunIISummer19UL18MiniAODv2-FlatPU0to75_106X_upgrade2018_realistic_v16_L1v1_ext2-v1/MINIAODSIM'
    #crabCommand('submit', config = config)
    ...
    config.General.requestName = 'SingleNeutrino_UL18_FlatPU0to75-ext1-v1-v1-2'
    config.Data.inputDataset = '/SingleNeutrino/RunIISummer19UL18MiniAODv2-FlatPU0to75_106X_upgrade2018_realistic_v16_L1v1_ext1-v1/MINIAODSIM'
    crabCommand('submit', config = config)

    config.General.requestName = 'SingleNeutrino_UL18_FlatPU0to75-ext2-v1-v1-2'
    config.Data.inputDataset = '/SingleNeutrino/RunIISummer19UL18MiniAODv2-FlatPU0to75_106X_upgrade2018_realistic_v16_L1v1_ext2-v1/MINIAODSIM'
    crabCommand('submit', config = config)
